...
void deallocate_memory(list_t * alloclist, list_t * freelist, int pid, int policy) { 
    ...
    */
    ...
    if (policy == 1){ list_add_to_back(freelist, deallocate_blk);
    } else if (policy == 2){ list_add_ascending_by_blocksize(freelist, deallocate_blk);
    } else if (policy == 3){ list_add_descending_by_blocksize(freelist, deallocate_blk);
    }
